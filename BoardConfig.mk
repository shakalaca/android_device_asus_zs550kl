...
# Kernel
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 androidboot.bootdevice=7824900.sdhci earlycon=msm_hsl_uart,0x78af000 buildv=WW_user_12.40.108.29_20161224 androidboot.selinux=permissive
...
TARGET_PREBUILT_KERNEL := device/asus/zs550kl/recovery/kernel
...
TARGET_SYSTEM_PROP := device/asus/zs550kl/system.prop
