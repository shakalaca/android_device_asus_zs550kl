...
BOARD_RECOVERY_IMAGE_PREPARE := \
  sed -i 's/ro.build.date.utc=.*/ro.build.date.utc=1513666653/g' $(TARGET_RECOVERY_ROOT_OUT)/prop.default
...
$(TEXFAT_MODULE): $(ANDROID_PRODUCT_OUT)/kernel
	...
	kernel/asus/Z018/scripts/sign-file sha512 \
